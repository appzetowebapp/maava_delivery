                  ...
                  children: [
                    InAppWebView(
                        ...
                        UserScript(
                          source: """
                            (function() {
                              ...
                              console.log('✅ Web Compatibility Shield Active');
                            })();
                          """,
                          injectionTime:
                      ...
                      onWebViewCreated: (controller) async {
                        ...
                        // Add JavaScript handler for Google Sign In (Backend alias)
                        controller.addJavaScriptHandler(
                          handlerName: 'nativeGoogleSignIn',
                          callback: (args) async {
                            debugPrint(
                                '🚀 Native Google Sign-In called from Website (alias)!');
                            final credential =
                            ...
                            if (credential != null && credential.user != null) {
                              ...
                              return {
                                'success': false,
                                'message': 'User cancelled or sign-in failed'
                              };
                            }
                          },
                        );

                        // Original Google Sign In handler
                        controller.addJavaScriptHandler(
                          handlerName: 'googleSignIn',
                          callback: (args) async {
                            debugPrint(
                                '🔑 Google Sign-In requested from website');
                            final credential =
                                await AuthService().signInWithGoogle();
                            if (credential != null && credential.user != null) {
                              debugPrint(
                                  '✅ Google Sign-In succeeded. Returning credentials to website.');
                              final idToken =
                                  await credential.user!.getIdToken();
                              return {
                                'success': true,
                              ...
                              debugPrint(
                                  '⚠️ Google Sign-In failed or was cancelled.');
                              return {
                                'success': false,
